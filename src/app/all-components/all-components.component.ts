...
import { IgcFormsModule, IGX_ACCORDION_DIRECTIVES, IGX_BANNER_DIRECTIVES, IGX_BUTTON_GROUP_DIRECTIVES, IGX_CALENDAR_DIRECTIVES, IGX_CARD_DIRECTIVES, IGX_DATE_PICKER_DIRECTIVES, IGX_DIALOG_DIRECTIVES, IGX_EXPANSION_PANEL_DIRECTIVES, IGX_GRID_DIRECTIVES, IGX_INPUT_GROUP_DIRECTIVES, IGX_LIST_DIRECTIVES, IGX_SELECT_DIRECTIVES, IGX_SIMPLE_COMBO_DIRECTIVES, IGX_SLIDER_DIRECTIVES, IGX_STEPPER_DIRECTIVES, IGX_TABS_DIRECTIVES, IGX_TREE_DIRECTIVES, IgxAvatarComponent, IgxBadgeComponent, IgxButtonDirective, IgxCheckboxComponent, IgxDividerDirective, IgxIconButtonDirective, IgxIconComponent, IgxOverlayOutletDirective, IgxRadioComponent, IgxRadioGroupDirective, IgxRippleDirective, IgxSnackbarComponent, IgxSwitchComponent, IgxToggleActionDirective, IgxToggleDirective } from '@infragistics/igniteui-angular';
...
@Component({
  ...
  standalone: true,
  imports: [IGX_EXPANSION_PANEL_DIRECTIVES, IGX_BUTTON_GROUP_DIRECTIVES, IGX_SIMPLE_COMBO_DIRECTIVES, IGX_INPUT_GROUP_DIRECTIVES, IGX_DATE_PICKER_DIRECTIVES, IGX_ACCORDION_DIRECTIVES, IGX_CALENDAR_DIRECTIVES, IGX_STEPPER_DIRECTIVES, IGX_SLIDER_DIRECTIVES, IGX_SELECT_DIRECTIVES, IGX_DIALOG_DIRECTIVES, IGX_BANNER_DIRECTIVES, IGX_TABS_DIRECTIVES, IGX_LIST_DIRECTIVES, IGX_TREE_DIRECTIVES, IGX_CARD_DIRECTIVES, IGX_GRID_DIRECTIVES, IgxToggleActionDirective, IgxOverlayOutletDirective, IgxIconButtonDirective, IgxRadioGroupDirective, IgxCategoryChartModule, IgxIconComponent, IgxAvatarComponent, IgxButtonDirective, IgxRippleDirective, IgxToggleDirective, IgxDividerDirective, IgxBadgeComponent, IgxCheckboxComponent, IgxRadioComponent, IgxSwitchComponent, IgcFormsModule, IgxSnackbarComponent, FormsModule, FormsModule],
